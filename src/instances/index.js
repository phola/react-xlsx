...
export const simple = () => {
  return (
    <WorkBook defaultCellStyle={defaultCellStyle} toXLSXCallback={handleXLSX}>
      <Sheet name='woooo'>
        <Cell row={0} col={1} width={600}>
          nested
        </Cell>
        <Cell cellRef='D1' width={300}>asasasas</Cell>
        <Cell cellRef='F9' colSpan={2} rowSpan={6} width={600}>merged</Cell>
      </Sheet>
      <Sheet name='hoooo'>
...
export const simpleNoCallback = () => {
  return (
    <WorkBook defaultCellStyle={defaultCellStyle}>
      <Sheet name='woooo'>
        <Cell row={0} col={1} colSpan={2} rowSpan={6}>
          <div>
            <div>
              nested
            </div>
